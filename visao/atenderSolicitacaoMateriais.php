...
<body id="home" class="homepage">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="solicitacaoUser.php">Minhas Solicitações</a></li>
    ...
    <section id="portfolio">
        <div class="container">
            ...
            <form id="form" action="../controle/solicitarMateriais.php" method="post">     
                ...
                <label>* DATA</label>
                <input name="data" type="text" class="p" id="data" value="<?php echo $DATA ?>">

                <label>* HORÁRIO MÁXIMO</label>
                <input name="horario" type="text" class="p" id="telefone" value="<?php echo $horario ?>" required>
