    ...
    <section id="portfolio">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">SISTEMA DE TRANSPORTES - INSTITUTO MARIO PENNA</h2>
            ...
            <div class="portfolio-items">
                <div class="portfolio-item web">
                    <div class="portfolio-item-inner">
                        <a href="listaChamados.php?idTipo=1"><img class="img-responsive" src="images/portfolio/suportePC.png"></a>                    </div>
              </div>/.portfolio-item -->

                <!-- <div class="portfolio-item web">
                    <div class="portfolio-item-inner">
                        <a href="listaChamados.php?idTipo=2"><img class="img-responsive" src="images/portfolio/mv.png" alt=""></a>                    </div>
              </div>/.portfolio-item -->

                <!-- <div class="portfolio-item web">
                    <div class="portfolio-item-inner">
                        <a href="listaChamados.php?idTipo=3"><img class="img-responsive" src="images/portfolio/internet.png" alt=""></a>                    </div>
              </div>/.portfolio-item -->

                <!-- <div class="portfolio-item web">
                    <div class="portfolio-item-inner">
                        <a href="listaChamados.php?idTipo=4"><img class="img-responsive" src="images/portfolio/imp.png" alt=""></a>                    </div>
              </div>/.portfolio-item -->

                <!-- <div class="portfolio-item web">
                    <div class="portfolio-item-inner">
                        <a href="listaChamados.php?idTipo=5"><img class="img-responsive" src="images/portfolio/totvs.png" alt=""></a>                    </div>
              </div>/.portfolio-item -->

                <!-- <div class="portfolio-item web">
                    <div class="portfolio-item-inner">
                        <a href="listaChamados.php?idTipo=6"><img class="img-responsive" src="images/portfolio/telefonia.png" alt=""></a>                    </div>
              </div>/.portfolio-item -->

                <!-- <div class="portfolio-item web">
                    <div class="portfolio-item-inner">
                        <a href="listaChamados.php?idTipo=7"><img class="img-responsive" src="images/portfolio/inter.png" alt=""></a>                    </div>
              </div>/.portfolio-item -->

              <div class="portfolio-item web">
                    <div class="portfolio-item-inner">
                        <a href="adminTransporte.php"><img class="img-responsive" src="images/portfolio/transporte.fw.png" alt=""></a>                    </div>
              </div><!--/.portfolio-item-->  
