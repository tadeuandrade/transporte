    ...
    <section id="portfolio">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">SISTEMA DE TRANSPORTE - INSTITUTO MARIO PENNA</h2>
                <p class="text-center wow fadeInDown">Todos os campos devem ser obrigatoriamente preenchidos</strong>:</p>
            </div>

             <div class="formulario">  

            <form id="form" action="../controle/cadastrarUsuario.php" method="post">                  
                 
                <label>NOME</label>
                <input name="nome" type="text" class="g" required>                 
                
                <label>MATRICULA(somente numeros)</label>
                <input name="matricula" type="number" class="g" required>

                <label>SETOR</label>
                <select name="cdSetor" required>
                    <option value="" selected disabled> INFORME O SETOR </option>
                    <?php
                        include_once('../controle/ctrlComboSetor.php');
                    ?>                    
                </select>
