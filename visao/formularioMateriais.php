...
<body id="home" class="homepage">
    ...
    <section id="portfolio">
        <div class="container">
            ...
            <form id="form" action="../controle/solicitarMateriais.php" method="post" enctype="multipart/form-data" autocomplete="on">                  
                ...
                <input name="empreOrigem" id="empreOrigem" type="text" class="g" onkeyup="javascript:naoPermiteAcento(this);" placeholder="INFORME A EMPRESA OU RESIDÊNCIA DE REFERENCIA">
                ...
                <label>EMPRESA / RESIDÊNCIA </label>
                <input name="empreDestino" id="empreDestino" type="text" class="g" onkeyup="javascript:naoPermiteAcento(this);" placeholder="INFORME A EMPRESA OU RESIDÊNCIA DE REFERENCIA">

                <label>* PONTO DE REFERENCIA</label>
                <input name="pontoReferencia" type="text" onkeyup="javascript:naoPermiteAcento(this);"  class="g" >
                ...
                <input name="telefoneDestino" type="text" class="p" id="telefoneDestino" onKeyPress="telefone(event, this)">

                <label>* DATA DO TRANSPORTE</label>
                <input name="data" type="text" class="p" id="data" required onKeyPress="DataHora(event, this)" maxlength="10">
                ...
                <input  id= "btn_submit" type="submit" value="Solicitar">
