            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll active"><a href="solicitacoes.php">Solicitações</a></li>
    ...
    <section id="portfolio">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">SOLICITAÇÃO</h2>
                <p class="text-center wow fadeInDown">Bem vindo ao sistema de solicitações de transporte, preencha o formulário abaixo:</p>
            </div>

            <div>
                <strong>SOLICITAÇÃO:</strong> <?php  echo $idSolicitacoes; ?> <BR>
                <strong>EMPRESA:</strong> <?php echo $empresa ?> / <strong>NOME:</strong> <?php echo $nome ?><BR>
                <strong>TELEFONE: <?php echo $telefone ?> </strong><BR> 
                <strong>ORIGEM:</strong> <?php echo $origem ?><br>
                <strong>SETOR:</strong> <?php echo $setor ?><BR>
                <strong>EMPRESA / RESIDÊNCIA:    </strong><?php echo $empreOrigem?> <BR>
                <strong>DESTINO:</strong> <?php echo $destino ?> <br><strong>EMPRESA / RESIDÊNCIA:</strong><?php echo $empreDestino?> <BR> 
                <strong>ENDEREÇO:</strong> <?php echo $endereco ?> <br> <strong>PONTO DE REFERENCIA:</strong> <?php echo $pontoReferencia ?><BR>
            ...
            <form id="form" action="../controle/atualizarSolicitacao.php?idSolicitacoes=<?php echo $_GET["idSolicitacoes"]?>" method="post">     
                ...
                <select name="idMotorista">
                    ...
                    <?php
                        include("../controle/ctrlComboMotoristaChamado.php");
                ...
                <select name="idVeiculo">
                    <?php
                        include("../controle/ctrlComboVeiculoChamado.php");
                ...
                <label> SOLICITAÇÕES RATEIO</label>
                <input type="text" name="idSolicitacaoRateio"  class="g" value="<?php ?>">

                <label> RECEBIDO POR </label>
                <input name="recebido"  id="recebido" type="text" class="p" value="<?php echo $recebido ?>">

                <label> NOTA FISCAL(NF): </label>
                <input name="notaFiscal" type="text" class="telefone" value="<?php echo $notaFiscal?> ">
