...
<body id="home" class="homepage">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <!-- <li class="scroll"><a href="#?>">Minhas Solicitações</a></li> -->
    ...
    <section id="portfolio">
        <div class="container">
            ...
            <form id="form" action="relatorioSolicitacoesPeriodoRateio.php" target="_blank" method="get">     
                ...
                <input name="dataInicial" type="text" class="p" id="data">

                <label>* DATA FINAL</label>
                <input name="dataFinal" type="text" class="p" id="data">
