            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll active"><a href="listaChamadosSistemas.php">Sistemas</a></li>
    ...
    <section id="portfolio">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">SISTEMA DE CHAMADOS - SISTEMAS</h2>
             ...
             <div class="formulario">  
              ...
              <?php
				include("../controle/listaChamadosSistemas.php");
				?>
