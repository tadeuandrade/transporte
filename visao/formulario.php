    ...
    <section id="portfolio">
        <div class="container">
            <div class="section-header">
                ...
                <p class="text-center wow fadeInDown">Bem vindo ao sistema de chamados, preencha os dados abaixo para ter acesso ao sistema. Caso ainda não tenha cadastro, clique na opção "REALIZAR CADASTRO":</p>
            </div>

             <div class="formulario">  

            <form id="form" action="../controle/cadastrarChamado.php?idTipo=<?php echo $_GET["idTipo"]?>" method="post">                  
                
                <label>* Nome</label>
                <input name="nome" type="text" class="g" value="<?php echo $nome_completo?>" required>
