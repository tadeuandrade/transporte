            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll active"><a href="meusChamados.php?matricula=<?php echo $_SESSION["matricula"] ?>">Meus Chamados</a></li>
    ...
    <section id="portfolio">
        <div class="container">
            ...
            <form class="form-inline" action="pesquisaChamado.php" type="get">
              ...
              <?php
				include("../controle/listaChamadosUsuarios.php");
				include("../controle/listaChamadosUsuariosFechados.php");
				?>
