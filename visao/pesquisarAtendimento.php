    ...
    <section id="portfolio">
        <div class="container">
            <div class="section-header">
                ...
                <p class="text-center wow fadeInDown">Bem vindo ao sistema de solicitações de transporte,informe o atendimento":</p>
            </div>

             <div class="formulario">  

            <form id="form" action="formularioPaciente.php" method="post">                  
