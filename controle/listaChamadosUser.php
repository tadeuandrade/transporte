	<?php
        ...
        $dao = new ChamadoDAO();
        $lista = $dao-> listaChamadosUser($user);
                ...
                $idChamado = $item -> getIdChamado();
                        ...
                        if ($STATUS == 'ABERTO'){
                            ...
                            echo '<tr>
                                    ...
                                    <td bgcolor="#FFFFFF"><div align="center"><a href="visualizarChamado.php?idChamado='.$idChamado.'"><i class="glyphicon glyphicon-pencil"></i></a></div></td>
                                  </tr>';
                            ...
                            echo '<tr>
                                    ...
                                    <td bgcolor="#CC99CC"><div align="center"><a href="visualizarChamado.php?idChamado='.$idChamado.'"><i class="glyphicon glyphicon-pencil"></i></a></div></td>
                                  </tr>';
                            ...
                            echo '<tr>
                                    ...
                                    <td bgcolor="#66CC99"><div align="center"><a href="visualizarChamado.php?idChamado='.$idChamado.'"><i class="glyphicon glyphicon-pencil"></i></a></div></td>
                                  </tr>';
                            ...
                            echo '<tr>
                                    ...
                                    <td bgcolor="#99CCFF"><div align="center"><a href="visualizarChamado.php?idChamado='.$idChamado.'"><i class="glyphicon glyphicon-pencil"></i></a></div></td>
                                  </tr>';
                           ...
                           echo '<tr>
                                    ...
                                    <td><div align="center"><a href="visualizarChamado.php?idChamado='.$idChamado.'"><i class="glyphicon glyphicon-pencil"></i></a></div></td>
                                  </tr>' ;
                        }
