...
// ini_set("display_errors", 1);
  ...
  // }
                        ...
                        if($dao-> solicitarMateriais($empresa, $nome, $telefone, $origem, $destino, $endereco, $pontoReferencia, $telefoneDestino, $data, $horario,$descricao, 
                                                     $moto, $anexo, $solicitante, 
                                                     $categoria, $enderecoOrigem, $setorDestino, $empreOrigem, $empreDestino, $procurarPor, $setor))
                        {
