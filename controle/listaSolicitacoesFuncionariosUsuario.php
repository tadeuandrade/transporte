...
ini_set("display_errors", 1);
        ...
        $lista = $dao-> listaSolicitacoesFuncionariosUsuario($usuario);
         ...
         if($lista)
         {
            echo '<table class="table table-borderless">
                      <thead class="thead">
                          <tr>
                            <th scope="col" colspan="10" class="bg-primary"><div align="center"><h5>SOLICITAÇÕES DE FUNCIONARIOS</h5></div></th>
                          </tr>
                        </thead> 
                      <thead>
                        <tr>
    	...
    	echo '</tbody>
                    ...
                    echo '<br>Não existe solicitacoes para funcionarios nesse momento!' ;
                           }
