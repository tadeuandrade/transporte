...
// ini_set("display_errors", 1);
  ...
  require_once('../modelo/Solicitacao.php');
    ...
    $formData = date('d/m/Y' , strtotime($data));
                        ...
                        if($dao-> solicitarDoacoes($empresa, $nome,$telefone,$origem,$setor,$destino, $endereco, $pontoReferencia, $telefoneDestino, $data, $horario, $acesso, $moveis, 
                                                   $descricao, $obs, $ajudante, $solicitante, $categoria, $enderecoOrigem, $empreOrigem, $empreDestino, $procurarPor))
                        {
